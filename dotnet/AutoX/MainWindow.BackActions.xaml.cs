...
namespace AutoX
{
    public partial class MainWindow : IDisposable
    {
        ...
        private  async void DeleteTask(TreeView parent)
        {
            ...
            await Task.Factory.StartNew(()=>DBFactory.GetData().Delete(toBeDeletedId));
        ...
        private static void ExportResultTask(TreeView parent)
        {
            ...
            var htmlString = DBUtils.GetHtmlHeader()+ DBUtils.ExportReulstToHtml(xElement)+DBUtils.GetHtmlFooter();
